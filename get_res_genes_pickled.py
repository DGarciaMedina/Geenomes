from preprocess import process_data, pick_data
import numpy as np
import pickle

in_file = "RPKMs.csv"
thresh = 0.2
cell_lines = ["M397", "M229", "M263"]

def main():    
    all_res_genes = []
    genes, data = pick_data(in_file, cell_lines)
    ...
    with open("res_gene_list.txt", 'wb') as handle:        
        pickle.dump(res_gene_list, handle)    
